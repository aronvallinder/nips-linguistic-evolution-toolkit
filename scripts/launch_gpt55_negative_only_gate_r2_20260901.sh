...
OUTPUT_SUBDIR="gpt55_negative_only_gate_r2_20260901"
LOG_ROOT="${LOG_ROOT:-/tmp/nlet-gpt55-negative-only-gate-r2-20260901}"
PARALLEL_RUNS="${PARALLEL_RUNS:-3}"

EXPERIMENTS=(
  gpt55_gate_dyad_game_r2
  gpt55_gate_dyad_game_myth_r2
  gpt55_gate_dyad_myth_game_r2
  gpt55_gate_population_game_r2
  gpt55_gate_population_game_myth_r2
  gpt55_gate_population_myth_game_r2
)
...
failures=()
echo "Starting GPT-5.5 negative-only gate replicate 1"
echo "Runs: 6 control cells"
...
echo "All six replicate-1 jobs returned successfully. Verify final full-state JSONs before declaring completion."
